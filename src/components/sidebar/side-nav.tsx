  ...
  return (
    <>
      ...
      <Button
        ...
        className="text-base w-full transition-all duration-300 ease-in-out hover:bg-primary-100 hover:text-primary-500 flex justify-start gap-3 text-neutral-400 font-bold"
      >
        <IconLogout />
        Log Out
      </Button>
