...
export default function ProtectedLayout({ children }: LayoutProps) {
  return (
    <>
      <div className="h-[64px] border border-b-[#E4E6E8] p-4 flex justify-between items-center w-full">
      ...
      <main className="relative h-[calc(100vh-64px)]">
        <aside
          id="sidebar"
          className="fixed left-0 top-[64px] z-40 h-screen w-[233px] transition-transform"
          aria-label="Sidebar"
        >
        ...
        <div className="bg-[#E4E6E8] h-full">{children}</div>
      </main>
    </>
  );
}
