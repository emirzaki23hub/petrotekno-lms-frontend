...
export default function DashboardLayout({
  ...
  return (
    <div className="flex flex-col h-full gap-6 overflow-hidden">
      ...
      <div className="flex font-mono border-[#E4E6E8] border-b">
        {navItems.map((item) => (
          <Link
            key={item.name}
            className={cn(
              "p-4 text-base text-neutral-700  border-b-4 border-transparent transition-transform duration-300 ease-linear",
              pathname === item.href &&
